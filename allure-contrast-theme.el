;;; allure-contrast-theme.el --- Theme 
...
;;; Code:
 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'allure-contrast
	...
	`(font-lock-negation-char-face ((,class (:foreground ,warning))))
	...
	`(font-lock-constant-face ((,class (:foreground ,const))))
        ...
        `(font-lock-type-face ((,class (:foreground ,classn ))))
	...
	`(cursor ((,class (:background ,func))))
        `(vertical-border ((,class (:foreground ,allureblack))))
...
(provide-theme 'allure-contrast)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; allure-contrast-theme.el ends here
